 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lx=_d("sun",[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]]),Gn=Ie(localStorage.getItem("theme")||"system");function Fx(){const n=()=>{const t=window.matchMedia("(prefers-color-scheme: dark)").matches;Gn.value==="dark"?document.documentElement.classList.add("dark"):Gn.value==="light"?document.documentElement.classList.remove("dark"):document.documentElement.classList.toggle("dark",t),localStorage.setItem("theme",Gn.value)};return ri(()=>{n();const t=window.matchMedia("(prefers-color-scheme: dark)"),r=s=>{Gn.value==="system"&&document.documentElement.classList.toggle("dark",s.matches)};t.addEventListener("change",r)}),pT(()=>{n()}),{theme:Gn,toggleTheme:()=>{Gn.value=Gn.value==="light"?"dark":Gn.value==="dark"?"system":"light"}}}const Ux={__name:"ThemeToggle",setup(n){const{theme:e,toggleTheme:t}=Fx();return(r,s)=>(_e(),xe("button",{onClick:s[0]||(s[0]=(...i)=>Pt(t)&&Pt(t)(...i)),class:"fixed bottom-24 left-6 md:bottom-24 md:left-16 rounded-full w-12 h-12 md:w-16 md:h-16 bg-[var(--color-blue-medium)] dark:bg-[var(--color-blue-strong)] text-[var(--color-black)] dark:text-[var(--button-text-light)] flex items-center justify-center gap-2 shadow-lg z-50"},[Pt(e)==="light"?(_e(),qr(Pt(Lx),{key:0,class:"w-6 h-6 md:w-7 md:h-7"})):Pt(e)==="dark"?(_e(),qr(Pt(Mx),{key:1,class:"w-6 h-6 md:w-7 md:h-7"})):(_e(),qr(Pt(Ox),{key:2,class:"w-6 h-6 md:w-7 md:h-7"}))]))}},Bx={class:"flex flex-col space-y-2"},$x=["for"],jx=["id","value"],qx=["value"],Ku={__name:"GeneralSelect",props:{label:String,id:String,options:Array,modelValue:String},setup(n){return(e,t)=>(_e(),xe("div",Bx,[q("label",{for:n.id,class:"text-md text-[var(--color-black)] dark:text-[var(--color-white)]"},Et(n.label)+":",9,$x),q("select",{id:n.id,value:n.modelValue,onChange:t[0]||(t[0]=r=>e.$emit("update:modelValue",r.target.value)),class:"border border-[var(--color-black)] rounded-2xl p-2 text-base bg-[var(--color-white)] text-[var(--color-black)] dark:bg-[var(--color-white)] dark:text-[var(--color-semi-black)] focus:outline-none focus:ring-2 focus:ring-[var(--color-blue)]"},[(_e(!0),xe(xt,null,kg(n.options,r=>(_e(),xe("option",{key:r,value:r},Et(r),9,qx))),128))],40,jx)]))}},zx={class:"flex flex-col space-y-2"},Kx=["for"],Hx=["id","value","placeholder"],Gx=["id","type","value","placeholder"],Qc={__name:"GeneralInput",props:{label:String,id:String,type:{type:String,default:"text"},placeholder:String,modelValue:String},setup(n){return(e,t)=>(_e(),xe("div",zx,[q("label",{for:n.id,class:"text-md font-medium text-[var(--color-black)] dark:text-[var(--color-white)]"},Et(n.label)+":",9,Kx),n.type==="textarea"?(_e(),xe("textarea",{key:0,id:n.id,value:n.modelValue,onInput:t[0]||(t[0]=r=>e.$emit("update:modelValue",r.target.value)),placeholder:n.placeholder,class:"border border-[var(--color-black)] rounded-2xl p-2 text-base bg-[var(--color-white)] text-[var(--color-black)] dark:bg-[var(--color-white)] dark:text-[var(--color-black)] focus:outline-none focus:ring-2 focus:ring-[var(--color-blue)] resize-y min-h-[96px]"},null,40,Hx)):(_e(),xe("input",{key:1,id:n.id,type:n.type,value:n.modelValue,onInput:t[1]||(t[1]=r=>e.$emit("update:modelValue",r.target.value)),placeholder:n.placeholder,class:"border border-[var(--color-black)] rounded-2xl p-2 text-base bg-[var(--color-white)] text-[var(--color-black)] dark:bg-[var(--color-white)] dark:text-[var(--color-black)] focus:outline-none focus:ring-2 focus:ring-[var(--color-blue)]"},null,40,Gx))]))}},Wx={__name:"CloseButton",emits:["close"],setup(n,{emit:e}){const t=e,r=()=>{t("close")};return(s,i)=>(_e(),xe("section",null,[q("button",{onClick:r,class:"px-4 py-2 bg-[var(--color-red)] hover:bg-[var(--color-black)] text-[var(--color-white)] font-semibold rounded-lg shadow-md"}," Volver ")]))}},Qx={__name:"SaveButton",props:{inputs:Object,selectValue:{type:[Object,String],default:""}},emits:["saveSuccess"],setup(n,{emit:e}){const t=n,r=e,s=()=>{const i=JSON.parse(localStorage.getItem("notes"))||[],o=new Date().toISOString(),l={title:t.inputs.noteTitle.trim(),etiquetas:t.inputs.noteEtiquetas.trim(),description:t.inputs.noteDescription.trim(),priority:t.selectValue.trim(),timestamp:o};t.inputs.index!==void 0&&t.inputs.index!==null?i[t.inputs.index]=l:i.push(l),localStorage.setItem("notes",JSON.stringify(i)),r("saveSuccess",{note:l,index:t.inputs.index})};return(i,o)=>(_e(),xe("section",null,[q("button",{onClick:s,class:"px-4 py-2 bg-[var(--color-blue-strong)] hover:bg-[var(--color-blue-strong)] text-[var(--color-white)] font-semibold rounded-lg shadow-md"}," Guardar ")]))}};function Jx({title:n,etiquetas:e,description:t,priority:r}){return!(!(n!=null&&n.trim())||!(e!=null&&e.trim())||!(t!=null&&t.trim())||!(r!=null&&r.trim()))}const Yx={class:"p-4 rounded-lg w-[95vw] max-w-md md:max-w-3xl mx-2 md:mx-auto relative bg-[var(--color-white)] dark:bg-[var(--color-semi-black)] border border-[var(--color-semi-black)] shadow-lg"},Xx={class:"text-2xl font-semibold mb-0 text-[var(--color-black)] dark:text-[var(--color-white)]"},Zx={class:"space-y-8"},e1={class:"flex gap-2 w-full"},t1={class:"flex justify-between mt-6"},n1={__name:"AddNoteModal",props:{isModalOpen:Boolean,noteData:Object,editIndex:Number},emits:["close","saveSuccess"],setup(n,{emit:e}){const t=n,r=e,s=Ie(""),i=Ie(""),o=Ie(""),l=Ie("Sin Prioridad"),c=Ie(""),u=Ie(!1),d=Ie(null);Ns(()=>t.noteData,I=>{I?(s.value=I.title,i.value=I.etiquetas,o.value=I.description,l.value=I.priority||"Sin Prioridad",c.value=I.timestamp,u.value=I.favorita??!1):(l.value="Sin Prioridad",u.value=!1)},{immediate:!0}),Ns(()=>t.isModalOpen,I=>{I&&vg(()=>{var R;(R=d.value)==null||R.focus()})});const p=()=>{r("close")},m=I=>{if(!Jx({title:s.value,etiquetas:i.value,description:o.value,priority:l.value})){alert("Todos los campos son obligatorios.");return}I.note.favorita=u.value,r("saveSuccess",I),p()};return(I,R)=>n.isModalOpen?(_e(),xe("section",{key:0,ref_key:"modalSection",ref:d,class:"fixed inset-0 bg-opacity-30 backdrop-blur-sm flex justify-center items-center z-50",onMousedown:an(p,["self"]),onKeydown:s_(p,["esc"]),tabindex:"0"},[q("div",Yx,[q("button",{onClick:p,class:"absolute top-2 right-2 text-xl font-bold text-[var(--color-black)] dark:text-[var(--color-white)]"}," × "),q("h2",Xx,Et(n.editIndex!==null?"Editar Nota":"Crear una nueva nota"),1),R[4]||(R[4]=q("hr",{class:"w-1/3 border-2 mb-4 border-[var(--color-blue)]"},null,-1)),q("div",Zx,[be(Ku,{label:"Prioridad",id:"noteType",options:["Alta","Media","Baja","Sin Prioridad"],modelValue:l.value,"onUpdate:modelValue":R[0]||(R[0]=k=>l.value=k)},null,8,["modelValue"]),q("div",e1,[be(Qc,{label:"Título",id:"noteTitle",type:"text",placeholder:"Título...",modelValue:s.value,"onUpdate:modelValue":R[1]||(R[1]=k=>s.value=k),class:"w-1/2 min-w-0 truncate text-sm","label-class":"text-xs"},null,8,["modelValue"]),be(Qc,{label:"Etiquetas",id:"noteEtiquetas",type:"text",placeholder:"Etiquetas...",modelValue:i.value,"onUpdate:modelValue":R[2]||(R[2]=k=>i.value=k),class:"w-1/2 min-w-0 truncate text-sm","label-class":"text-xs"},null,8,["modelValue"])]),be(Qc,{label:"Descripción",id:"noteDescription",type:"textarea",placeholder:"Descripción...",modelValue:o.value,"onUpdate:modelValue":R[3]||(R[3]=k=>o.value=k)},null,8,["modelValue"])]),q("div",t1,[be(Qx,{inputs:{noteTitle:s.value,noteEtiquetas:i.value,noteDescription:o.value,timestamp:c.value,index:n.editIndex,favorita:u.value},selectValue:l.value,onSaveSuccess:m},null,8,["inputs","selectValue"]),be(Wx,{onClose:p,class:"ml-auto"})])])],544)):uh("",!0)}},r1={class:"w-full"},s1={__name:"SearchInput",props:{modelValue:String},emits:["update:modelValue","search"],setup(n,{emit:e}){const t=n,r=e,s=Ie(t.modelValue||""),i=()=>{r("update:modelValue",s.value),r("search",s.value)};return(o,l)=>(_e(),xe("div",r1,[l[1]||(l[1]=q("label",{for:"searchBox",class:"block mb-1 text-[var(--color-black)] dark:text-[var(--color-white)]"}," Buscar notas: ",-1)),wa(q("input",{id:"searchBox",type:"text","onUpdate:modelValue":l[0]||(l[0]=c=>s.value=c),onInput:i,placeholder:"Buscar...",class:"border border-[var(--color-black)] rounded-2xl p-2 text-base w-full bg-[var(--color-white)] text-[var(--color-black)] dark:bg-[var(--color-white)] dark:text-[var(--color-black)]"},null,544),[[uu,s.value]])]))}};function i1(n){return os(()=>{const e=n.value.flatMap(t=>t.etiquetas?t.etiquetas.split(","):[]).map(t=>t.trim()).filter(t=>t);return["Todas",...new Set(e)]})}const o1={class:"flex flex-col lg:flex-row items-center justify-center gap-2 pb-2 bg-[var(--color-grey-page)] dark:bg-[var(--color-black)] w-full"},a1={class:"flex flex-col items-center justify-center h-full mb-1 lg:mb-0 lg:mr-6 lg:w-auto w-full"},l1={class:"text-xs text-[var(--color-semi-black)] dark:text-[var(--color-grey)] mt-1 text-center opacity-70"},c1={class:"flex flex-col md:flex-row items-center gap-4 md:gap-6 md:justify-center overflow-x-auto md:overflow-x-visible px-3 md:px-0 lg:w-auto w-full"},u1={class:"flex flex-row gap-2 md:gap-4 justify-center min-w-0 max-w-[500px] mx-auto"},h1={class:"flex flex-row gap-1 md:gap-4 justify-center items-center min-w-0 max-w-xs w-full md:max-w-[500px] md:mx-auto"},d1=["aria-label"],f1={class:"flex flex-row items-center gap-1 md:mt-6"},p1={__name:"Filtros",props:{notes:{type:Array,default:()=>[]},filteredNotesCount:{type:Number,default:0},totalNotesCount:{type:Number,default:0}},emits:["filter","search","order","toggleFavorites"],setup(n,{emit:e}){const t=n,r=e,s=Ie("Todas"),i=Ie("Todas"),o=Ie(""),l=Ie("Más reciente"),c=Ie(!1),u=os(()=>t.notes),d=i1(u),p=()=>{r("filter",{priority:s.value,tag:i.value})},m=()=>{r("search",o.value)},I=k=>{l.value=k,r("order",l.value)},R=()=>{c.value=!c.value,r("toggleFavorites",c.value)};return(k,x)=>(_e(),xe("div",o1,[q("div",a1,[x[5]||(x[5]=q("h2",{class:"text-3xl font-semibold text-[var(--color-black)] dark:text-[var(--color-white)] mt-2 whitespace-nowrap text-center"}," Notas creadas ",-1)),q("span",l1,Et(n.filteredNotesCount)+" de "+Et(n.totalNotesCount)+" notas ",1),x[6]||(x[6]=q("hr",{class:"border-2 border-[var(--color-blue)] dark:border-[var(--color-blue-strong)] w-44 mt-1"},null,-1))]),q("div",c1,[q("div",u1,[be(Ku,{label:"Prioridad",id:"priorityFilter",options:["Todas","Sin Prioridad","Alta","Media","Baja"],modelValue:s.value,"onUpdate:modelValue":x[0]||(x[0]=B=>s.value=B),onChange:p,class:"w-28 xs:w-32 p-2 text-base md:w-44 md:p-5 md:text-base"},null,8,["modelValue"]),be(Ku,{label:"Etiquetas",id:"tagsFilter",options:Pt(d),modelValue:i.value,"onUpdate:modelValue":x[1]||(x[1]=B=>i.value=B),onChange:p,class:"w-28 xs:w-32 p-2 text-base md:w-44 md:p-5 md:text-base"},null,8,["options","modelValue"])]),q("div",h1,[be(s1,{modelValue:o.value,"onUpdate:modelValue":x[2]||(x[2]=B=>o.value=B),onInput:m,class:"mb-5 md:mb-0 w-32 sm:w-36 md:w-60 p-2 text-base md:p-5 md:text-base"},null,8,["modelValue"]),q("button",{onClick:R,"aria-label":c.value?"Mostrar todas las notas":"Mostrar solo favoritas",class:"p-1 rounded transition flex items-center mr-1 md:mr-3 md:mt-6 bg-transparent",type:"button"},[(_e(),xe("svg",{xmlns:"http://www.w3.org/2000/svg",class:kt(["w-7 h-7 md:w-8 md:h-8 transition-colors",c.value?"text-yellow-400":"text-gray-400"]),fill:"currentColor",viewBox:"0 0 24 24"},x[7]||(x[7]=[q("path",{d:"M12 17.75l-6.172 3.245 1.179-6.873-5-4.873 6.9-1.002L12 2.25l3.093 6.997 6.9 1.002-5 4.873 1.179 6.873z"},null,-1)]),2))],8,d1),q("div",f1,[x[10]||(x[10]=q("span",{class:"mr-1 text-xs md:text-base text-[var(--color-black)] dark:text-[var(--color-white)] whitespace-nowrap"},"Por fecha:",-1)),q("button",{onClick:x[3]||(x[3]=B=>I("Más reciente")),"aria-label":"Ordenar por más reciente",class:kt(["p-1 rounded transition",l.value==="Más reciente"?"bg-[var(--color-blue-medium)] dark:bg-[var(--color-blue-strong)]":"hover:bg-[var(--color-grey)] dark:hover:bg-[var(--color-semi-black)]"])},[(_e(),xe("svg",{xmlns:"http://www.w3.org/2000/svg",class:kt(["w-5 h-5",l.value==="Más reciente"?"text-[var(--color-black)] dark:text-[var(--color-white)]":"text-[var(--color-semi-black)] dark:text-[var(--color-grey)]"]),fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},x[8]||(x[8]=[q("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1)]),2))],2),q("button",{onClick:x[4]||(x[4]=B=>I("Más antiguo")),"aria-label":"Ordenar por más antiguo",class:kt(["p-1 rounded transition",l.value==="Más antiguo"?"bg-[var(--color-blue-medium)] dark:bg-[var(--color-blue-strong)]":"hover:bg-[var(--color-grey)] dark:hover:bg-[var(--color-semi-black)]"])},[(_e(),xe("svg",{xmlns:"http://www.w3.org/2000/svg",class:kt(["w-5 h-5",l.value==="Más antiguo"?"text-[var(--color-black)] dark:text-[var(--color-white)]":"text-[var(--color-semi-black)] dark:text-[var(--color-grey)]"]),fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},x[9]||(x[9]=[q("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 15l7-7 7 7"},null,-1)]),2))],2)])])])]))}};function _I(n){if(!n)return"Fecha no disponible";const e=new Date(n);return`${e.toLocaleDateString()} - ${e.toLocaleTimeString()}`}const m1={class:"absolute top-2 right-2 z-20"},g1={class:"flex flex-col flex-grow ml-6 h-full justify-between relative z-10"},_1={class:"text-2xl font-bold text-[var(--color-blue-strong)] dark:text-[var(--color-blue-strong)] mt-0"},y1={class:"mb-3 text-md text-[var(--color-black)] dark:text-[var(--color-black)] mt-2 whitespace-pre-line break-words break-all overflow-y-auto max-h-24"},v1={class:"flex flex-col mt-auto"},I1={class:"text-sm text-[var(--color-semi-black)] dark:text-[var(--color-semi-black)]"},E1={class:"text-xs text-[var(--color-semi-black)] dark:text-[var(--color-semi-black)]"},T1={class:"absolute bottom-3 right-3 flex gap-2 z-20"},w1={__name:"NoteCard",props:{note:Object},emits:["delete","edit","toggleFavorite","showDetail"],setup(n,{emit:e}){const t=n,r=e,s=os(()=>{switch(t.note.priority){case"Alta":return"bg-[var(--color-red)]";case"Media":return"bg-[var(--color-yellow)]";case"Baja":return"bg-[var(--color-blue-medium)]";default:return"bg-[var(--color-semi-black)]"}});function i(){r("showDetail",t.note)}function o(){r("toggleFavorite",t.note)}return(l,c)=>(_e(),xe("div",{class:"flex flex-col p-4 rounded-lg shadow-md w-[95vw] max-w-sm md:max-w-md min-h-[180px] md:min-h-[200px] relative mx-auto mb-8 bg-[var(--color-white)] dark:bg-[var(--color-grey)] cursor-pointer",onClick:i},[q("div",{class:kt([s.value,"absolute left-0 top-0 bottom-0 w-4 rounded-l-lg h-full"])},null,2),q("div",m1,[q("button",{onClick:an(o,["stop"]),class:"p-1 rounded-full focus:outline-none bg-transparent",type:"button"},[(_e(),xe("svg",{xmlns:"http://www.w3.org/2000/svg",class:kt(["w-8 h-8 transition-colors",n.note.favorita?"text-yellow-400":"text-gray-400"]),fill:"currentColor",viewBox:"0 0 24 24"},c[2]||(c[2]=[q("path",{d:"M12 17.75l-6.172 3.245 1.179-6.873-5-4.873 6.9-1.002L12 2.25l3.093 6.997 6.9 1.002-5 4.873 1.179 6.873z"},null,-1)]),2))])]),q("div",g1,[q("h3",_1,Et(n.note.title),1),q("p",y1,Et(n.note.description),1),q("div",v1,[q("p",I1,Et(n.note.etiquetas),1),q("p",E1,Et(Pt(_I)(n.note.timestamp)),1)])]),q("div",T1,[q("button",{onClick:c[0]||(c[0]=an(u=>l.$emit("edit"),["stop"])),class:"px-3 py-2 rounded-md text-sm hover:opacity-90 bg-[var(--color-blue-strong)] dark:bg-[var(--color-blue-strong)] text-[var(--color-white)]"}," Editar "),q("button",{onClick:c[1]||(c[1]=an(u=>l.$emit("delete"),["stop"])),class:"px-3 py-2 rounded-md text-sm hover:opacity-90 bg-[var(--color-red)] text-[var(--color-white)]"}," Eliminar ")])]))}},b1={key:0,class:"mt-10 mb-10 text-center text-[var(--color-semi-black)] dark:text-[var(--color-grey)] text-lg"},A1={__name:"NotesList",props:{filteredNotes:{type:Array,default:()=>[]}},setup(n){return(e,t)=>n.filteredNotes.length===0?(_e(),xe("div",b1,' ¡No hay notas aún! Pulsa el botón "+" para agregar tu primera nota. ')):(_e(),qr(lw,{key:1,name:"note-fade",tag:"div",class:"grid grid-cols-1 md:grid-cols-2 gap-x-2 gap-y-2 mt-0 w-full max-w-6xl mx-auto"},{default:bg(()=>[(_e(!0),xe(xt,null,kg(n.filteredNotes,r=>(_e(),qr(w1,{key:r.id,note:r,onShowDetail:s=>e.$emit("showDetail",r),onDelete:s=>e.$emit("delete",r.id),onEdit:s=>e.$emit("edit",r.id),onToggleFavorite:s=>e.$emit("toggleFavorite",r.id)},null,8,["note","onShowDetail","onDelete","onEdit","onToggleFavorite"]))),128))]),_:1}))}},S1={class:"flex flex-col flex-grow ml-6 h-full justify-between relative z-10"},R1={class:"text-2xl font-bold text-[var(--color-blue-strong)] dark:text-[var(--color-blue-strong)] mt-0"},P1={class:"mb-3 text-md text-[var(--color-black)] dark:text-[var(--color-black)] mt-2 whitespace-pre-line break-words break-all overflow-y-auto max-h-32 md:max-h-56 pr-2",style:{"scrollbar-gutter":"stable"}},C1={class:"flex flex-col mt-auto"},x1={class:"text-sm text-[var(--color-semi-black)] dark:text-[var(--color-semi-black)]"},k1={class:"text-xs text-[var(--color-semi-black)] dark:text-[var(--color-semi-black)]"},V1={class:"absolute bottom-3 right-3 flex gap-2 z-20"},D1={__name:"NoteDetailModal",props:{note:Object},emits:["close","edit","delete"],setup(n,{emit:e}){const t=n,r=e,s=Ie(null),i=()=>r("close"),o=d=>{d.key==="Escape"&&i()};ri(()=>{window.addEventListener("keydown",o)}),oh(()=>{window.removeEventListener("keydown",o)});const l=()=>{r("edit",t.note),r("close")},c=()=>{r("delete",t.note),r("close")},u=os(()=>{switch(t.note.priority){case"Alta":return"bg-[var(--color-red)]";case"Media":return"bg-[var(--color-yellow)]";case"Baja":return"bg-[var(--color-blue-medium)]";default:return"bg-[var(--color-semi-black)]"}});return(d,p)=>(_e(),xe("div",{class:"fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50",onMousedown:an(i,["self"])},[q("div",{class:"flex flex-col p-4 rounded-lg shadow-md w-[95vw] max-w-sm md:max-w-md min-h-[180px] md:min-h-[200px] relative mx-2 mb-8 bg-[var(--color-white)] dark:bg-[var(--color-grey)] overflow-hidden",ref_key:"modalRef",ref:s},[q("div",{class:kt([u.value,"absolute left-0 top-0 bottom-0 w-4 rounded-l-lg h-full"])},null,2),q("div",S1,[q("button",{onClick:i,class:"absolute top-2 right-2 text-xl font-bold z-20 text-[var(--color-black)] dark:text-[var(--color-white)]"},"×"),q("h3",R1,Et(n.note.title),1),q("p",P1,Et(n.note.description),1),q("div",C1,[q("p",x1,Et(n.note.etiquetas),1),q("p",k1,Et(Pt(_I)(n.note.timestamp)),1)])]),q("div",V1,[q("button",{onClick:an(l,["stop"]),class:"px-3 py-2 rounded-md text-sm hover:opacity-90 bg-[var(--color-blue-strong)] dark:bg-[var(--color-blue-strong)] text-[var(--color-white)]"}," Editar "),q("button",{onClick:an(c,["stop"]),class:"px-3 py-2 rounded-md text-sm hover:opacity-90 bg-[var(--color-red)] text-[var(--color-white)]"}," Eliminar ")])],512)],32))}};function N1(n,e,t,r,s){return os(()=>{let i=n.value.filter(o=>{var p,m,I;const l=o.priority||"Sin Prioridad",c=e.value==="Todas"||l===e.value,u=t.value==="Todas"||o.etiquetas&&o.etiquetas.split(",").map(R=>R.trim().toLowerCase()).includes(t.value.trim().toLowerCase()),d=!r.value||((p=o.title)==null?void 0:p.toLowerCase().includes(r.value.toLowerCase()))||((m=o.description)==null?void 0:m.toLowerCase().includes(r.value.toLowerCase()))||((I=o.etiquetas)==null?void 0:I.toLowerCase().includes(r.value.toLowerCase()));return c&&u&&d});return s&&s.value&&(i=i.slice().sort((o,l)=>s.value==="Más reciente"?new Date(l.timestamp)-new Date(o.timestamp):new Date(o.timestamp)-new Date(l.timestamp))),i})}const O1={class:"flex flex-col items-center pb-40 md:pb-0 w-full max-w-full overflow-x-hidden bg-[var(--color-grey-page)] dark:bg-[var(--color-black)]"},M1={__name:"NotesBody",setup(n){const{notes:e,loadNotes:t,addNote:r,updateNote:s,deleteNote:i}=gd(),o=Ie(!1),l=Ie({}),c=Ie(null),u=Ie("Todas"),d=Ie("Todas"),p=Ie(""),m=Ie("Más reciente"),I=Ie(!1),R=N1(e,u,d,p,m),k=os(()=>I.value?R.value.filter(_=>_.favorita):R.value);function x({priority:_,tag:oe}){u.value=_,d.value=oe}function B(_){p.value=_}function z(_){m.value=_}function j(_){I.value=_}function $(_=null,oe=null){_?(l.value={..._},c.value=_.id):(l.value={title:"",etiquetas:"",description:"",priority:"Sin Prioridad",timestamp:"",favorita:!1},c.value=null),o.value=!0}function Z(){o.value=!1}function ee({note:_,index:oe}){oe!=null?(s(_,oe),Z()):r(_).then(()=>Z()).catch(()=>{})}function b(_){i(_)}function y(_){const oe=e.value.find(Oe=>Oe.id===_);oe&&$(oe,_)}function v(_){const oe=e.value.find(Oe=>Oe.id===_);if(oe){const Oe={...oe,favorita:!oe.favorita};s(Oe,_)}}const w=Ie(!1),A=Ie(null);function T(_){A.value=_,w.value=!0}return ri(t),(_,oe)=>(_e(),xe("div",O1,[be(Ux),q("button",{onClick:oe[0]||(oe[0]=Oe=>$(null,null)),class:"fixed bottom-24 right-6 md:bottom-24 md:right-16 rounded-full w-12 h-12 md:w-16 md:h-16 bg-[var(--color-blue-medium)] dark:bg-[var(--color-blue-strong)] text-[var(--color-black)] dark:text-[var(--color-white)] flex items-center justify-center gap-2 shadow-lg z-50"},[(_e(),xe("svg",{class:kt(["w-6 h-6 md:w-7 md:h-7","text-[var(--color-black)] dark:text-[var(--color-white)]"]),fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},oe[4]||(oe[4]=[q("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M12 5v14m7-7H5"},null,-1)])))]),be(n1,{isModalOpen:o.value,noteData:l.value,editIndex:c.value,onClose:Z,onSaveSuccess:ee},null,8,["isModalOpen","noteData","editIndex"]),be(p1,{notes:Pt(e),filteredNotesCount:k.value.length,totalNotesCount:Pt(e).length,onFilter:x,onSearch:B,onOrder:z,onToggleFavorites:j},null,8,["notes","filteredNotesCount","totalNotesCount"]),be(A1,{filteredNotes:k.value,onShowDetail:T,onDelete:b,onEdit:y,onToggleFavorite:v},null,8,["filteredNotes"]),w.value?(_e(),qr(D1,{key:0,note:A.value,onClose:oe[1]||(oe[1]=Oe=>w.value=!1),onEdit:oe[2]||(oe[2]=Oe=>y(A.value.id)),onDelete:oe[3]||(oe[3]=Oe=>b(A.value.id))},null,8,["note"])):uh("",!0)]))}},L1={class:"min-h-screen flex flex-col"},F1={class:"flex-1 flex flex-col"},U1={__name:"App",setup(n){return(e,t)=>(_e(),xe("div",L1,[be(Ax),q("main",F1,[be(M1)]),be(xx)]))}};Ew(U1).mount("#app");
